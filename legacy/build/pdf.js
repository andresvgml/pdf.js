...
function getAdjustmentTransformation(transform, width, height) {
  var patternTransform = (0, _pattern_helper.createMatrix)(transform);
...
function createMatrix(matrix) {
  ...
  if (!svgElement) {
    var svgFactory = new _display_utils.DOMSVGFactory();
...
var RadialAxialShadingPattern = /*#__PURE__*/function (_BaseShadingPattern) {
  ...
  _createClass(RadialAxialShadingPattern, [{
    key: "getPattern",
    value: function getPattern(ctx, owner) {
      var shadingFill = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      var patternTransform = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
...
var XfaLayer = /*#__PURE__*/function () {
  ...
  _createClass(XfaLayer, null, [{
    key: "setupStorage",
    value: function setupStorage(html, fieldId, element, storage, intent) {
    ...
    value: function render(parameters) {
      ...
      var _iterator3 = _createForOfIteratorHelper(rootDiv.querySelectorAll(".xfaDisabled input, .xfaDisabled textarea")),
          _step3;
      ...
      var _iterator4 = _createForOfIteratorHelper(rootDiv.querySelectorAll(".xfaReadOnly input, .xfaReadOnly textarea")),
          _step4;
...
var pdfjsVersion = '2.10.167';
var pdfjsBuild = '277f35129';
{
  if (_is_node.isNodeJS) {
